...
if __name__ == "__main__":
    ...
    parser.add_argument('-set', '--settings',default= SETTINGS, type=str, help='Открывает .json файл')
    ...
    match args.program:
        case 0:      
            # генерируем ключи
                ...
                files_funct.serialization_rsa_public_key(public_key,settings['public_key'],)
                files_funct.serialization_rsa_private_key(private_key, settings['secret_key'])
